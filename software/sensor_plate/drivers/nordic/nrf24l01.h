...
#define spi_send_read_byte(byte)		nordic_transfer_byte(byte)
...
//Change these definitions (and then recompile) to suit your particular application.
#define nrf24l01_IRQ_IOREGISTER		1
#define nrf24l01_IRQ_PINMASK		0
...
#define nrf24l01_SETUP_RETR_DEFAULT_VAL		0x0F //Change to 0x0F for 15 retries from 0x03
#define nrf24l01_RF_CH_DEFAULT_VAL			0x22 //Change to 0x22 channel from 0x02
...
unsigned char nrf24l01_read_register(unsigned char regnumber, unsigned char * data, 
									 unsigned int len);
unsigned char nrf24l01_write_tx_payload(unsigned char * data, unsigned int len, 
										bool transmit);
