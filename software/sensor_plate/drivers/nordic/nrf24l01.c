...
//	delay_10us_multiple(150);
	timer16DelayUS(0, 750);
	timer16DelayUS(0, 750);
...
unsigned char nrf24l01_write_register(unsigned char regnumber, unsigned char * data, 
									  unsigned int len)
{
	return nrf24l01_execute_command(nrf24l01_W_REGISTER | 
								    (regnumber & nrf24l01_W_REGISTER_DATA), data, len, false);
}
...
//	nrf24l01_CE_IOREGISTER &= ~nrf24l01_CE_PINMASK;
	gpioSetValue (nrf24l01_CE_IOREGISTER, nrf24l01_CE_PINMASK, 0);
}
...
{
//	nrf24l01_CE_IOREGISTER |= nrf24l01_CE_PINMASK;
	gpioSetValue (nrf24l01_CE_IOREGISTER, nrf24l01_CE_PINMASK, 1);
}
...
//	if((nrf24l01_CE_IOREGISTER & nrf24l01_CE_PINMASK) != 0)
	if(gpioGetValue (nrf24l01_CE_IOREGISTER, nrf24l01_CE_PINMASK) != 0)
		return true;
	else
		return false;
}
...
//	nrf24l01_CSN_IOREGISTER &= ~nrf24l01_CSN_PINMASK;
	gpioSetValue (nrf24l01_CSN_IOREGISTER, nrf24l01_CSN_PINMASK, 0);
}
...
{
//	nrf24l01_CSN_IOREGISTER |= nrf24l01_CSN_PINMASK;
	gpioSetValue (nrf24l01_CSN_IOREGISTER, nrf24l01_CSN_PINMASK, 1);
}
...
//	if((nrf24l01_CSN_IOREGISTER & nrf24l01_CSN_PINMASK) != 0)
	if(gpioGetValue (nrf24l01_CSN_IOREGISTER, nrf24l01_CSN_PINMASK) != 0)
		return true;
	else
		return false;	
}
...
//	if((nrf24l01_IRQ_IOREGISTER & nrf24l01_IRQ_PINMASK) != 0)
	if(gpioGetValue (nrf24l01_IRQ_IOREGISTER, nrf24l01_IRQ_PINMASK) != 0)	
		return false;
	else
		return true;
}
...
//but rather use one of the 8 SPI data instructions
