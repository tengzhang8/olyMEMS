...
//MODIFIED
  ...
  SCB_USBCLKSEL = SCB_USBCLKSEL_SOURCE_INPUTCLOCK;

  SCB_USBCLKUEN = SCB_USBCLKUEN_UPDATE;         // Update Clock Source
  SCB_USBCLKUEN = SCB_USBCLKUEN_DISABLE;        // Toggle Update Register
  SCB_USBCLKUEN = SCB_USBCLKUEN_UPDATE;
