...
#define nrf24l01_CE_PINMASK			(1<<PB6)
...
#define nrf24l01_SETUP_RETR_DEFAULT_VAL		0x0F				//Changed from 0x03 into 0x0F for 15 retries
#define nrf24l01_RF_CH_DEFAULT_VAL			0x22				//Changed from 0x02 this changes the RF frequency
